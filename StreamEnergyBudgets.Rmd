...
# Colorblind-friendly palette developed by IBM, 4 and 5 color version
ibm4 <- c("#785EF0", "#DC267F", "#FE6100", "#FFB000")
ibm5 <- c("#648FFF", "#785EF0", "#DC267F", "#FE6100", "#FFB000")
```

```{r calculate_LINXII, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r calculate_CAREER, echo = FALSE, message = FALSE, warning = FALSE}
...
# Merge sites_LINXII with CAREER_sites
sites <- full_join(CAREER_sites, LINXII_sites) %>% filter(Organization != "Other")
