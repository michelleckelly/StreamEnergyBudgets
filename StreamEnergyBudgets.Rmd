...
```{r plotMapLINXII, fig.cap="Map of Marcarelli Nationwide Survey (n = 7), and LINXII (n = 49) study sites used in this analysis. Yellow = Marcarelli Nationwide site, blue = LINXII site.", echo = FALSE, message = FALSE, warning = FALSE, fig.pos="center", fig.height=6, fig.width = 10}
...
```{r CAREERDenitRatevsPercentTotalNRG, fig.cap=" Dashed line has a slope of 1, representing a denitrification rate proportional to the fraction of total energy released from denitrification.", fig.height=6, fig.width=6, fig.pos="H"}
...
```{r LINXIIPredictiveModel, eval = F}
...
# Display fit results
data.frame(plsResults, enetResults, nnetResults, marsResults, svmRResults, knnResults, forestResults, boostResults)
