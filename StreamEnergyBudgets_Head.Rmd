...
CAREER <- CAREER %>% 
  ...
  rename(Denit_mgNm2hr = "ProcessRate_UnamendedDenit",
         Denit.SE_mgNm2hr = "SE_UnamendedDenit",
         AmendedDenit_mgNm2hr = "ProcessRate_Amended",
         AmendedDenit.SE_mgNm2hr = "SE_Amended",
         NFix_mgNm2hr = "ProcessRate_N fixation",
         NFix.SE_mgNm2hr = "SE_N fixation")
...
CAREER$EnergyDenit_kCalm2hr <- convertDenit(CAREER$Denit_mgNm2hr)
CAREER$EnergyTot_kCalm2hr <- CAREER$EnergyDenit_kCalm2hr + 
  CAREER$EnergyER_kCalm2hr
CAREER$EnergyDenit_percent <- CAREER$EnergyDenit_kCalm2hr / 
  CAREER$EnergyTot_kCalm2hr * 100
CAREER$EnergyER_percent <- CAREER$EnergyER_kCalm2hr / 
  CAREER$EnergyTot_kCalm2hr * 100
...
# Remove (0,0) datapoints
LINXII %>% 
  filter(Denit_mgNm2hr != 0) %>% 
  summarise(mean(EnergyDenit_percent, na.rm = T))
LINXII %>% 
  filter(EnergyDenit_percent != 0 && Denit_mgNm2hr != 0) %>% 
  summarise(mean(EnergyDenit_percent, na.rm = T))
