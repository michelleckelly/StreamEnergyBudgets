...
```{r NO3vsPercentTotalNRG, fig.cap="NO3- is an even better predictor of the percentage of total released energy via denitrification than it is of denitrification rate for LINXII streams.", fig.height=5, fig.pos="H"}
a <- 
  ggplot(data = LINXII, 
...
![Table 8.7 [@stumm_aquatic_1996 pp. 474].](images/Table8-7.jpeg)

![Figure 8.14 [@stumm_aquatic_1996 pp. 477].](images/Figure8-14.jpeg){height=75%}
